<%-- 
    Document   : buscarCajero
    Created on : 13/11/2020, 01:38:19 PM
    Author     : sergi
--%>
...
<html>
    ...
    <body>
        <c:if test="${verificar == 0}">
            <h1>No esta en su horario de trabajo, no puede actualizar a un cajero/h1>            
        </c:if>
        ...
        <c:if test="${verificar == 1}">
               ...
               <div class="datos">                   
                   ...
                   <form action="buscarCajero" method="POST">
                    <%--Codigo --%>
                    <label for="codigo">Codigo del cajero</label>
                     <input type="number" name="codigo" required="required" placeholder="codigo del cajero"> 
                    <%--DPI --%>                   
