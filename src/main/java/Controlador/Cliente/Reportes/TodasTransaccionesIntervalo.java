 ...
 * @author sergi
 */
@WebServlet("/todasTransaccionesIntervalo")
public class TodasTransaccionesIntervalo extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try{
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=TodasTransaccionesIntervaloTiempoCuenta.pdf");//cambia
            
            File file = new File(request.getServletContext().getRealPath("/resources/TodasTransaccionesIntervaloTiempo.jrxml"));//cambia
